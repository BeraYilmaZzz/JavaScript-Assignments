const menu = [
  ...
  },
  {
    ...
    price: 5.99,
    img:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9gjwj9OR-t4izhRN_1-646yxV7c-GblmefQ&usqp=CAU",
...
function displayMenu(menuItems) {
    const menuHTML = menuItems.map(item => {
      return `
        <div class="menu-item col-lg-4 col-md-6 cl-xl-6">
...
// Kategori filtreleri için kategorileri bul
...
function createFilterButtons() {
  ...
  // Filtre butonlarına click event listener ekle
